...
# ------------------------------------------------------------
# 5️⃣ Criar diretório /data-lake e ajustar permissões
# ------------------------------------------------------------
echo "📁 Criando diretório /data-lake no HDFS (se não existir)..."
$HDFS_BIN dfs -mkdir -p /data-lake
$HDFS_BIN dfs -chown guest:supergroup /data-lake
$HDFS_BIN dfs -chmod 777 /data-lake
echo "✅ Diretório /data-lake criado e configurado para guest:supergroup com permissão 777"

# ------------------------------------------------------------
# 6️⃣ Verificar status com JPS
# ------------------------------------------------------------
echo "----------------------------------------------"
...
# ------------------------------------------------------------
# 7️⃣ Teste rápido de conectividade HDFS
# ------------------------------------------------------------
